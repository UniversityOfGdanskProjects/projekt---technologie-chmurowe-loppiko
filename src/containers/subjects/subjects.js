...
function Subjects() {
    ...
    const skillArray = subjectsData[semesterId]
        .map((subject, skillId) => {
    ...
    return (
        <div className="subjects-page">
            {displaySubjectDescription && <SubjectDescription database={subjectsData} handleTransparentOnClick={() => setSubjectIsVisable(false)}/>}
            ...
            <div className="subjects-content">
                ...
                {
                    subjectsData[semesterId].map((subject, index) => {
                        return(
                        <div className="subject-frame" key={ subject["subject-name"] }>
                            ...
                            { returnTurningPath(index, subjectsData[semesterId].length) }
                            { returnPhoneTurningPath(index, subjectsData[semesterId].length) }
                        </div>
                    )})
                }
                { returnEndingPath(subjectsData[semesterId].length) }
